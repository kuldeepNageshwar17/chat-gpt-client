...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    setChatLog(newChat);
    const message = newChat.map((chat) => chat.message).join("");
    ...
    setChatLog((pre) => [...pre, { user: "gpt", message: data.message }]);
  };
  const clearChatLog = () => {
    setChatLog([]);
  };
    ...
    <div className={`chat-message ${message.user === "gpt" ? "chatgpt" : ""} `}>
      <div className="chat-message-center">
        ...
        <div className="message">
          ...
          {/* <textarea disabled defaultValue={message.message}></textarea> */}
        </div>
      </div>
    </div>
  );
